...
class ClimateController(BaseController):
    ...
    def __init__(self):
        ...
        self._sun_sensor = SUN_SENSOR_STATUS.OFF
        self._acc_voltage = 0
    ...
    def window_max(self, value):
        ...
        if self._controller.auto == AC_COOL_MODE_AUTO.ON and self.sun_sensor == SUN_SENSOR_STATUS.OFF:
    ...
    def fan_speed(self, value):
        ...
        if self._controller.auto == AC_COOL_MODE_AUTO.ON:
            self._controller.auto = AC_COOL_MODE_AUTO.OFF
    ...
    @sun_sensor.setter
    def sun_sensor(self, value):
        self._sun_sensor = value
        # commands.INITED_COMMANDS[commands.COMMAND_NAMES.ACWindowMaxOnCommand]()
