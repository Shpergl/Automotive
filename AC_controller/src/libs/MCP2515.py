...
class MCP2515:
    ...
    def _write_message(self, tx_buffer, message_obj):
        ...
        print('isinstance(message_obj, Message): ', isinstance(message_obj, Message))# write a byte to the TXBnDLC register
        print('type(message_obj): ', type(message_obj))
        print('type(Message): ', type(Message))
        if isinstance(message_obj, Message):
            print('message_obj.data', message_obj.data)
